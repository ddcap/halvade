...
touch $halvade_tmp/ref/STAR_ref/.star_ref
$halvade_tmp/bin/STAR --genomeDir $halvade_tmp/ref/STAR_ref/ --genomeFastaFiles ucsc.hg19.fasta --runMode genomeGenerate --runThreadN $cpu
...
check_smt=${3:-0} # either 0 (false) or 1 (true)
if [ $check_smt -eq 1 ];
then	
		smt='echo "smt"'
else
